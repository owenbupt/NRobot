...
% Export an image from each iteration of the simulation in order to create a
% video
...
figure('Name','State','units','normalized','outerposition',[0 0 1 1]);
for s=1:iterations
	% Plot state
	hold on
	axis off
	...
	plot_AABB(simulation_parameters.axis, 'w.');
	plot_state( simulation_parameters, agents, agent_state, s, colors );
